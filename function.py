...
def compute_df_score(df_product, df_rating):
    ...
    df_product_copy = df_product[['url', 'product_id', 'parfum', 'parfum_list', 'name', 'price', 'category', 'brand']].copy()
    ...
    return df_product_copy[['name', 'category', 'parfum', 'score', 'avg_rating', 'nb_reviews', 'price', 'url', 'product_id', 'brand', 'parfum_list']]
